...
public:
    ...
    student(const std::string& last_name,
        ...
        const std::vector<int>& scores) // socre's vector
    ...
    float get_average_score() const
    {
        ...
        unsigned int count_scores = static_cast<unsigned int>(scores_.size());
        ...
        float average_score =
            static_cast<float>(sum_scores) / static_cast<float>(count_scores);
